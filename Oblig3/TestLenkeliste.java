public class TestLenkeliste {
    ...
    static void testLeggTilOgFjerningAvFlereElementer() {
        ...
        sjekk("Element 0", liste.hent(0), "hent(0) i liste med 4 elementer");//7
        sjekk("Element 3", liste.hent(3), "hent(3) i liste med 4 elementer"); //8
        sjekk("Element 0", liste.fjern(), "fjern() i liste med 4 elementer");
        sjekk("Element X", liste.fjern(), "fjern() (for andre gang) i liste med 3 elementer"); //10
    ...
    static void testLeggTilPaaIndeks() {
        ...
        sjekk("Element X", liste.hent(0), "hent(0) etter leggTil(0, \"Element X\")"); //12
        ...
        sjekk(6, liste.stoerrelse(), "stoerrelse() etter leggTil med og uten indeks"); //17
    }
    ...
    static void testFjernOgSettMedIndeks() {
        ...
        sjekk(4, liste.stoerrelse(), "stoerrelse() etter flere kall paa fjern() og leggTil()"); //23
    }
